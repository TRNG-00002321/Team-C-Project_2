...
class TestAuthenticationAPI:
    ...
    # Status tests
    @allure.story("Employee auth status")
    @allure.title("Test status unauthenticated")
    ...
    @allure.story("Employee auth status")
    @allure.title("Test status authenticated valid credentials")
    @allure.severity(allure.severity_level.NORMAL)
    ...
    @allure.story("Employee auth status")
    @allure.title("Test status invalid credentials")
    @allure.severity(allure.severity_level.NORMAL)
